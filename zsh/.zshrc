...
export FZF_BASE='/home/parallels/.fzf/bin/fzf'
...
export ZEEHAWK_BUILD_DIR=/home/parallels/zeehawk/build


# attempt to make history not have duplicates
...
__conda_setup="$('/home/parallels/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
